...
class Game():
    ...
    def __init__(self):
        ...
        self.all_graphics = [f for f in os.listdir('graphic/memory/content_finance') if
                             os.path.isfile(os.path.join('graphic/memory/content_finance', f)) and f.endswith(
                                 ('.png', '.jpg', '.jpeg'))] # Create a list of filenames of graphics that end with ".png", ".jpg", or ".jpeg" in the "graphic/memory/content_finance" directory
