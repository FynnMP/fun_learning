...
class CircularProgressbar(object):
    ...
    def start(self, interval=40):
        ...
        self.arc_id = self.canvas.create_arc(self.x0, self.y0, self.x1, self.y1,
                                             ...
                                             width=self.width, outline="black", style='arc')
        percent = '0%'
    ...
    def step(self, delta):
        ...
        if self.running:
            ...
            if self.extent > self.full_extent:
                self.extent = self.full_extent
                self.canvas.itemconfigure(self.arc_id, outline="black")
...
class Application(tk.Frame):
    ...
    def createWidgets(self):
        self.canvas = tk.Canvas(width=200, height=200, bg='white')
